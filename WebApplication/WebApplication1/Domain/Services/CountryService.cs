...
namespace WebApplication1.Domain.Services
{
    public class CountryService : ICountryService
    {
        ...
        Task<Country> ICountryService.CreateCountryAsync(Country country)
        {
            throw new NotImplementedException();
        }

        Task ICountryService.CreateCountryAsync()
        {
            throw new NotImplementedException();
        }

        Task<Country> ICountryService.DeleteCountryAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        Task<Country> ICountryService.EditCountryAsync(Country country)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<Country>> ICountryService.GetCountriesAsync()
        {
            throw new NotImplementedException();
        }

        Task<Country> ICountryService.GetCountryById(Guid id)
        {
            throw new NotImplementedException();
        }
